      ...
      <div className="about_me">
        ...
        <article className="about_me_msg">
          ...
          <p className="about_me_description">
            ...
            with the IT world, I have met and collaborated with so many talented
            people to create high quality digital products. I am a quiet person,
            curious by nature, and I am always working to improve my skills, my
            philosophy :{" "}
